...
class ProfileHospitalJU2Widget extends StatefulWidget {
  const ProfileHospitalJU2Widget({Key key}) : super(key: key);

  @override
  _ProfileHospitalJU2WidgetState createState() =>
      _ProfileHospitalJU2WidgetState();
}

class _ProfileHospitalJU2WidgetState extends State<ProfileHospitalJU2Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 535 3444';
  @override
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 10, 0, 0),
                                      child: Text(
                                          '  JUH has been keen throughout\n  the four decades of its history\n  to provide a noble message and\n  a clear vision that are based on\n  patient care for Jordanians,\n  Arabs,and citizens of neighboring\n  countries.',
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/76i8aKGCMSrtvERK7');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43171');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getJu2.php');
