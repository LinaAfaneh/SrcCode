...
class ProfileArabBank1Widget extends StatefulWidget {
  const ProfileArabBank1Widget({Key key}) : super(key: key);

  @override
  _ProfileArabBank1WidgetState createState() => _ProfileArabBank1WidgetState();
}

class _ProfileArabBank1WidgetState extends State<ProfileArabBank1Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 535 0651';
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                onTap: () async {
                                                  await launchURL(
                                                      'https://maps.app.goo.gl/NwrC4XFfBJ7oC9oA6');
                                                },
                                                child: Container(
                                                  width: 40,
                                                  height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43164');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getArab1.php');
