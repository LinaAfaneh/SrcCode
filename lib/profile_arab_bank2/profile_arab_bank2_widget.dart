...
DateQminder() {
  ...
  //var url =('https://api.qminder.com/v1/tickets/search?minCreated={$dateCurr}T01:00:00Z&location=43031');
  return dateCurr;
}
...
class ProfileArabBank2Widget extends StatefulWidget {
  const ProfileArabBank2Widget({Key key}) : super(key: key);

  @override
  _ProfileArabBank2WidgetState createState() => _ProfileArabBank2WidgetState();
}

class _ProfileArabBank2WidgetState extends State<ProfileArabBank2Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 592 2030';
                        ...
                        Container(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Image.asset(
                                  'assets/images/top-banks-jordan.jpg',
                                  width: 375,
                                  height: 160,
                                  fit: BoxFit.fill,
                                ),
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 10, 20, 0),
                                      child: Text(
                                          '  Arab Bank is one of the largest\n  financial institutions in the Middle\n  East,founded in 1930 in Jerusalem,\n  Mandatory Palestine, as the first\n  private sector financial institution\n  in the Arab world.',
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/upR1abiBqTauYVMH8');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 0, 30, 0),
                                          child: Text(
                                            ' Waiting time (each person) : 15 min',
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1
                                                .override(
                                                  fontFamily: 'Poppins',
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43165');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getArab2.php');
