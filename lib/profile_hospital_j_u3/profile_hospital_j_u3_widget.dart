...
class ProfileHospitalJU3Widget extends StatefulWidget {
  const ProfileHospitalJU3Widget({Key key}) : super(key: key);

  @override
  _ProfileHospitalJU3WidgetState createState() =>
      _ProfileHospitalJU3WidgetState();
}

class _ProfileHospitalJU3WidgetState extends State<ProfileHospitalJU3Widget> {
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43172');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getJu3.php');
