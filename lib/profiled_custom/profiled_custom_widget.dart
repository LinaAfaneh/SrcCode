...
class ProfiledCustomWidget extends StatefulWidget {
  const ProfiledCustomWidget({Key key}) : super(key: key);

  @override
  _ProfiledCustomWidgetState createState() => _ProfiledCustomWidgetState();
}

class _ProfiledCustomWidgetState extends State<ProfiledCustomWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 462 3186';
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 10, 0, 0),
                                      child: Text(
                                          '  The Department’s tasks and\n  responsibilities have broadened to\n  encompass active contribution to\n  national economy support,\n  investment promotion and trade\n  facilitation.',
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1
                                              .override(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/AbeJrJpAsFzyTXdFA');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 0, 30, 0),
                                          child: Text(
                                            '  Waiting time (each person): 45 min', //waiting time
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1
                                                .override(
                                                  fontFamily: 'Poppins',
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43177');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getCustom.php');
