...
class ProfiledDriver2Widget extends StatefulWidget {
  const ProfiledDriver2Widget({Key key}) : super(key: key);

  @override
  _ProfiledDriver2WidgetState createState() => _ProfiledDriver2WidgetState();
}

class _ProfiledDriver2WidgetState extends State<ProfiledDriver2Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 488 8888';
  @override
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 10, 0, 0),
                                      child: Text(
                                          '  The Drivers and Vehicles Licensing\n  Department that were operating\n  on the road transport system ,\n  which existed at the time ,\n  was signed  by the Public Security\n  Department , and is associated with\n  the commander of the Jordanian\n  Arab Army .',
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1
                                              .override(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/pnPQSYTmRJHSdvix5');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 0, 30, 0),
                                          child: Text(
                                            '  Waiting time (each person): 25 min ',
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1
                                                .override(
                                                  fontFamily: 'Poppins',
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43174');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getDriver2.php');
