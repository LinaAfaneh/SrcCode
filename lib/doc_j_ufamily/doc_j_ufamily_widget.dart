...
import '../profile_hospital_j_u2/profile_hospital_j_u2_widget.dart';

class DocJUfamilyWidget extends StatefulWidget {
  const DocJUfamilyWidget({Key key}) : super(key: key);

  @override
  _DocJUfamilyWidgetState createState() => _DocJUfamilyWidgetState();
}

class _DocJUfamilyWidgetState extends State<DocJUfamilyWidget> {
                    ...
                    onTap: () async {
                      await Navigator.push(
                        ...
                        PageTransition(
                          ...
                          duration: Duration(milliseconds: 300),
                          reverseDuration: Duration(milliseconds: 300),
                          child: ProfileHospitalJU2Widget(),
                        ),
                      );
                    },
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Dr. Farihan Fakhri Al-Barghouti',
                          style:
