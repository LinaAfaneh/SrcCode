...
class ProfileHospitalJU1Widget extends StatefulWidget {
  const ProfileHospitalJU1Widget({Key key}) : super(key: key);

  @override
  _ProfileHospitalJU1WidgetState createState() =>
      _ProfileHospitalJU1WidgetState();
}

class _ProfileHospitalJU1WidgetState extends State<ProfileHospitalJU1Widget> {
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43170');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getJu1.php');
