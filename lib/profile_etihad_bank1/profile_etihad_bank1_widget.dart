...
class ProfileEtihadBank1Widget extends StatefulWidget {
  const ProfileEtihadBank1Widget({Key key}) : super(key: key);

  @override
  _ProfileEtihadBank1WidgetState createState() =>
      _ProfileEtihadBank1WidgetState();
}

class _ProfileEtihadBank1WidgetState extends State<ProfileEtihadBank1Widget> {
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/1Br68jWGQfAGm1F19');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43167');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getEtihad1.php');
