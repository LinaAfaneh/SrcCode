...
import '../department_j_u/department_j_u_widget.dart';
import '../flutter_color/flutter_color_theme.dart';
import '../flutter_color/flutter_color_util.dart';
import '../home_page/home_page_widget.dart';

class CategoryClinicsWidget extends StatefulWidget {
  const CategoryClinicsWidget({Key key}) : super(key: key);

  @override
  _CategoryClinicsWidgetState createState() => _CategoryClinicsWidgetState();
}

class _CategoryClinicsWidgetState extends State<CategoryClinicsWidget> {
