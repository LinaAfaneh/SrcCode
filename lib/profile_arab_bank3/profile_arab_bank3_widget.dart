...
class ProfileArabBank3Widget extends StatefulWidget {
  const ProfileArabBank3Widget({Key key}) : super(key: key);

  @override
  _ProfileArabBank3WidgetState createState() => _ProfileArabBank3WidgetState();
}

class _ProfileArabBank3WidgetState extends State<ProfileArabBank3Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(05) 385 4918';
  @override
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/Bz8yW1xYZcTfw9W17');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43166');
...
Future<dynamic> DiagramTV() async {
  var url = Uri.parse('https://visiondb.000webhostapp.com/Places/getArab3.php');
