...
class ProfileEtihadBank2Widget extends StatefulWidget {
  const ProfileEtihadBank2Widget({Key key}) : super(key: key);

  @override
  _ProfileEtihadBank2WidgetState createState() =>
      _ProfileEtihadBank2WidgetState();
}

class _ProfileEtihadBank2WidgetState extends State<ProfileEtihadBank2Widget> {
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/w16MeHALRvmXmFqD6');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43168');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getEtihad2.php');
