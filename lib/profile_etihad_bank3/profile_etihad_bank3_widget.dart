...
class ProfileEtihadBank3Widget extends StatefulWidget {
  const ProfileEtihadBank3Widget({Key key}) : super(key: key);

  @override
  _ProfileEtihadBank3WidgetState createState() =>
      _ProfileEtihadBank3WidgetState();
}

class _ProfileEtihadBank3WidgetState extends State<ProfileEtihadBank3Widget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final phoneNum = '(06) 560 7011';
  @override
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 10, 0, 0),
                                      child: Text(
                                        '  Bank al Etihad was established\n  in 1978 as a Jordanian banking\n  and financial services organization\n  with family and human values at\n  the core of its operations.',
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/ekqhKSSsmzDF2CqD8');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43169');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getEtihad3.php');
