...
import '../profile_hospital_j_u3/profile_hospital_j_u3_widget.dart';

class DocJUdermaWidget extends StatefulWidget {
  const DocJUdermaWidget({Key key}) : super(key: key);

  @override
  _DocJUdermaWidgetState createState() => _DocJUdermaWidgetState();
}

class _DocJUdermaWidgetState extends State<DocJUdermaWidget> {
                    ...
                    onTap: () async {
                      await Navigator.push(
                        ...
                        PageTransition(
                          ...
                          duration: Duration(milliseconds: 300),
                          reverseDuration: Duration(milliseconds: 300),
                          child: ProfileHospitalJU3Widget(),
                        ),
                      );
                    },
                    child: Column(
