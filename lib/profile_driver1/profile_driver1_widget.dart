...
class ProfileDriver1Widget extends StatefulWidget {
  const ProfileDriver1Widget({Key key}) : super(key: key);

  @override
  _ProfileDriver1WidgetState createState() => _ProfileDriver1WidgetState();
}

class _ProfileDriver1WidgetState extends State<ProfileDriver1Widget> {
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/n5PeWGKtSJW4VJV16');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43173');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getDriver1.php');
