...
class ProfiledStatus2Widget extends StatefulWidget {
  const ProfiledStatus2Widget({Key key}) : super(key: key);

  @override
  _ProfiledStatus2WidgetState createState() => _ProfiledStatus2WidgetState();
}

class _ProfiledStatus2WidgetState extends State<ProfiledStatus2Widget> {
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                await launchURL(
                                                    'https://maps.app.goo.gl/ThLsfK5TaJxRpt3y9');
                                              },
                                              child: Container(
                                                width: 40,
                                                height: 40,
...
Future<dynamic> QminderApi() async {
  ...
  var url = Uri.parse(
      'https://api.qminder.com/v1/tickets/search?minCreated=${why}T01:00:00Z&location=43176');
...
Future<dynamic> DiagramTV() async {
  var url =
      Uri.parse('https://visiondb.000webhostapp.com/Places/getStatus2.php');
